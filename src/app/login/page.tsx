...
function LoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
        ...
        startTransition(async () => {
                ...
                if (!data) { setError(ERROR_MAP['no_encontrado']); return }
          ...
          {/* ── Panel izquierdo: imagen industrial ── */}
                <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden">
                  ...
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img src="/warehouse-bg.png" alt="Almacén inteligente Unidad Minera Jabalí" className="w-full h-full object-cover" />
                        ...
                        <div className="absolute bottom-10 left-12 z-10">
                                  <div className="flex items-center gap-3 mb-4">
                                              ...
                                              <span className="text-white font-bold text-lg tracking-wide">CIS Nicaragua</span>span>
                                  </div>div>
                                  <h2 className="text-white text-3xl font-extrabold leading-tight drop-shadow-lg">
                                              Sistema de Gestión<br/>de Almacén
                                  </h2>h2>
                                  <p className="text-blue-200 text-sm mt-2 drop-shadow">Unidad Minera Jabalí · Nicaragua</p>p>
                                  <div className="flex items-center gap-2 mt-4 bg-green-500/10 border border-green-500/20 rounded-full px-3 py-1.5 w-fit">
                                              ...
                                              <span className="text-green-400 text-xs font-medium">Conectado a Supabase</span>span>
                                  </div>div>
                        </div>div>
                </div>div>
                      ...
                      <div className="w-full max-w-sm">
                        {/* Logo mobile */}
                                <div className="lg:hidden text-center mb-8">
                                            ...
                                            <h1 className="text-xl font-bold text-white">CIS Nicaragua</h1>h1>
                                </div>div>
                      
                        {/* Encabezado */}
                                <div className="mb-8">
                                            <h1 className="text-2xl font-extrabold text-white tracking-tight">Iniciar sesión</h1>h1>
                                            <p className="text-slate-400 text-sm mt-1">Ingresa tus credenciales para continuar</p>p>
                                </div>div>
                                            ...
                                            <div>
                                                          ...
                                                          <div className="relative">
                                                            ...
                                                            <input
                                                                              ...
                                                                              />
                                                                          <button type="button" onClick={() => setShowPwd(v => !v)} className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-500 hover:text-slate-300 transition-colors">
                                                                            {showPwd
                                                                                                  ? <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>svg>
