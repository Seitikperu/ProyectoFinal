          ...
          <main className="min-h-screen flex items-stretch font-sans">
                <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden">
                    ...
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                        ...
                        <div className="absolute bottom-10 left-12 z-10">
                                  ...
                                  <p className="text-blue-200 text-sm mt-2 drop-shadow">Unidad Minera Jabali - Nicaragua</p>p>
                ...
                <div className="flex-1 flex items-center justify-center bg-slate-950 px-8 py-12">
                        <div className="w-full max-w-sm">
                                  ...
                                  <div className="mb-8">
                                              <h1 className="text-2xl font-extrabold text-white tracking-tight">Iniciar sesion</h1>h1>
