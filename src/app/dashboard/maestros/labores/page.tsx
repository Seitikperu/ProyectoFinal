...
export default function Page() {
  return (
    <div className="p-6 max-w-screen-2xl mx-auto">
      <h1 className="text-xl font-bold text-white mb-2">Labores</h1>
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-12 text-center mt-6">
        ...
        <p className="text-slate-400 font-medium">Labores</p>
        <p className="text-slate-600 text-sm mt-1">Tabla: <code className="text-blue-400">mlabor</code> — 747 registros pendientes</p>
