  ...
  return (
    <div className="p-6 max-w-screen-2xl mx-auto">
      <div className="flex items-center gap-4">
            <BackButton />
            <h1 className="text-xl font-bold text-white mb-2">Centros de Costo</h1>
          </div>
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-12 text-center mt-6">
        ...
        <p className="text-slate-400 font-medium">Centros de Costo</p>
        <p className="text-slate-600 text-sm mt-1">Tabla: <code className="text-blue-400">centros_costo</code> — 1,157 registros pendientes</p>
